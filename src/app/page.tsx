...
import { Sparkles, Printer, Download, Search, Palette, Heart, CheckCircle2, ArrowRight } from "lucide-react";
...
export default function HomePage() {
  const popularPages = COLORING_PAGES.filter((p) => p.popular).slice(0, 8);
  const featuredCategories = CATEGORIES.filter((c) => c.featured).slice(0, 8);
  const newPages = COLORING_PAGES.slice(0, 4);

  const exampleSearches = [
    { label: "Unicorn coloring pages", href: "/coloring-pages/unicorn/" },
    { label: "Dinosaur coloring pages", href: "/coloring-pages/dinosaurs/" },
    { label: "Princess coloring pages", href: "/coloring-pages/princesses/" },
    { label: "Cat coloring pages", href: "/coloring-pages/animals/" },
    { label: "Christmas coloring pages", href: "/coloring-pages/christmas/" },
    { label: "Halloween coloring pages", href: "/coloring-pages/halloween/" },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 tracking-tight leading-tight">
              Free Coloring Pages for <span className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">Kids & Adults</span>
            </h1>

            <p className="text-lg sm:text-xl text-slate-600 leading-relaxed max-w-2xl mx-auto font-normal">
              Explore thousands of free coloring pages you can color online, print at home, or download as PNG files.
            </p>
            ...
            {/* Hero Search Bar & Popular Pills */}
            <div className="pt-6 max-w-2xl mx-auto space-y-3">
              <SearchBar placeholder="Search coloring pages (e.g. unicorn, dino, cat)..." size="lg" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-16">
        ...
        <section>
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
            ...
            >
              View All Coloring Pages <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
        ...
        <section className="bg-slate-50 p-8 sm:p-12 rounded-3xl border border-slate-200/80">
          <div className="text-center max-w-2xl mx-auto mb-10 space-y-2">
            ...
            <p className="text-slate-600 text-sm">
              Discover themed collections from mythical unicorns to outer space adventures.
            </p>
          </div>
        ...
        {/* Color Online Explanation Section */}
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-5">
            ...
            <p className="text-slate-600 leading-relaxed text-sm sm:text-base">
              No need for paper, crayons, or messy cleanups! ColoringNest features an interactive, touch-friendly digital coloring tool. Click or tap any closed shape to flood-fill colors instantly, use the freehand brush for custom shading, or undo stokes anytime.
            </p>
            ...
            <div className="pt-4">
              ...
              >
                Try Online Coloring Editor <ArrowRight className="w-4 h-4" />
              </Link>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-tr from-indigo-100 via-purple-100 to-pink-100 p-8 rounded-3xl border border-indigo-200/60 flex items-center justify-center">
            <div className="bg-white p-6 rounded-2xl shadow-xl border border-slate-100 space-y-4 w-full max-w-md text-center">
              ...
              <h3 className="font-bold text-slate-900 text-lg">Interactive Canvas</h3>
              <p className="text-xs text-slate-500 leading-relaxed">
                Save your progress directly in your browser. Download high-definition PNG files of your finished artwork anytime!
              </p>
            </div>
          </div>
        </section>

        {/* Printable Coloring Pages Explanation Section */}
        <section className="bg-slate-900 text-white p-8 sm:p-12 rounded-3xl shadow-xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="space-y-4">
            ...
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
              Prefer classic crayons, colored pencils, or watercolor markers? Download and print any sheet in seconds. Our printable designs use sharp vector line art optimized for standard Letter and A4 paper sizes.
            </p>
            <div className="pt-2 flex flex-wrap gap-4 text-xs font-semibold text-slate-300">
              <span className="bg-slate-800 px-3.5 py-2 rounded-xl border border-slate-700">✓ Letter & A4 Ready</span>
              <span className="bg-slate-800 px-3.5 py-2 rounded-xl border border-slate-700">✓ High Resolution 300 DPI</span>
              <span className="bg-slate-800 px-3.5 py-2 rounded-xl border border-slate-700">✓ Ink-Saving Outlines</span>
            </div>
          </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-8">
            ...
            <Link href="/coloring-pages/" className="text-sm font-bold text-indigo-600 hover:text-indigo-800">
              See All →
            </Link>
          </div>
        ...
        {/* Coloring Ideas & Activities by Age */}
        <section className="space-y-6">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            ...
            <p className="text-slate-600 text-sm">
              Tailored coloring pages and learning resources for every developmental stage.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Super simple thick outlines, large shapes, alphabet letters, and basic cute animals to build early fine motor skills.
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Educational sight word worksheets, count-and-color sheets, dinosaurs, and fairytale stories.
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Intricate botanical art, floral mandalas, zen patterns, and detailed wildlife for relaxation and mindfulness.
              </p>
            </Link>
          </div>
        </section>
